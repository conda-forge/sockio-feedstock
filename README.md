...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sockio-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12523&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sockio-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sockio` can be installed with:

```
conda install sockio
```

It is possible to list all of the versions of `sockio` available on your platform with:
